...
[ApiController]
[Route("[controller]")]
public class StatusReadinessController : ControllerBase
{
    public static bool Healthy { get; set; } = true;
    private readonly ILogger<StatusReadinessController> _logger;

    public StatusReadinessController(ILogger<StatusReadinessController> logger)
    {
        _logger = logger;
    }
